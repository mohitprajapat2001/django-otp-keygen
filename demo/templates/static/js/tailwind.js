 ...
 * Original file: /npm/@tailwindcss/browser@4.1.10/dist/index.global.js
 *
...
;(() => {
              ...
              t.functional(n, (t) => {
                ...
                if ("arbitrary" === t.value.kind) {
                  ...
                  switch (
                    ...
                    default:
                      return (
                        (r = Fe(r, t.modifier, e)), null === r ? void 0 : o.color(r)
                      )
                  }
                }
                {
            ...
            if (t.value) {
              if ("arbitrary" === t.value.kind) {
                ...
                switch (
                  ...
                  default:
                    return (
                      (r = Fe(r, t.modifier, e)), null === r ? void 0 : [x("color", r)]
                    )
                }
              }
              {
          ...
          t.functional("text-shadow", (t) => {
            ...
            }
            {
              ...
              if (r)
                return [
                  T(),
                  x("--tw-text-shadow-color", Ne(r, "var(--tw-text-shadow-alpha)")),
                ]
            }
          }),
          r("text-shadow", () => [
            ...
            t.functional("inset-shadow", (t) => {
              ...
              }
              {
                ...
                if (r)
                  return [
                    s(),
                    x("--tw-inset-shadow-color", Ne(r, "var(--tw-inset-shadow-alpha)")),
                  ]
              }
            }),
            r("inset-shadow", () => [
      ...
      r = (function (e) {
          ...
          r("details-content", ["&::details-content"])
        {
          ...
          t.static(
            ...
            (t) => {
              t.nodes = [
                k("&::before", [e(), x("content", "var(--tw-content)"), ...t.nodes]),
              ]
            },
            {compounds: 0}
          ),
            t.static(
              ...
              (t) => {
                t.nodes = [
                  k("&::after", [e(), x("content", "var(--tw-content)"), ...t.nodes]),
                ]
              },
              {compounds: 0}
            )
            ...
            for (let [e, r] of i)
              switch (t.variants.kind(e)) {
                ...
                case "functional": {
                  ...
                  if (null === r)
                    return {kind: "functional", root: e, modifier: t, value: null}
                  if ("]" === r[r.length - 1]) {
                    if ("[" !== r[0]) continue
                    let n = F(r.slice(1, -1))
  ...
  function Yt(e, {config: t, base: r, path: n, reference: o}) {
    ...
    for (let t of i)
      e.plugins.push(t),
        t.config &&
          Yt(e, {path: n, base: r, config: t.config, reference: !!t.reference})
    let a = t.content ?? [],
    ...
    C(r, (e, {parent: t, replaceWith: r, context: n}) => {
      if ("at-rule" === e.kind) {
        ...
        if ("@config" === e.name) {
          ...
          return (
            l.push({id: e.params.slice(1, -1), base: n.base, reference: !!n.reference}),
            r([]),
            void (i |= 4)
          )
        }
  ...
  function tr({
    ...
    let a = 0,
      l = [
        ...i.map((e) => {
          if (!e.options)
            return {config: {plugins: [e.plugin]}, base: e.base, reference: e.reference}
            ...
            if (r.startsWith("source(")) {
              ...
              C(e.nodes, (e, {replaceWith: r}) => {
                if (
                  ...
                  return (
                    (e.params += ` source(${t})`), r([A({sourceBase: n.base}, [e])]), 2
                  )
              })
  ...
  async function cr(e, r = {}) {
    let n = t(e, {from: r.from}),
      o = await (async function (e, t = {}) {
        ...
        n.unshift($("! tailwindcss v4.1.10 | MIT License | https://tailwindcss.com "))
        let u = new Set(),
          d = null,
          f = 0,
          p = !1
  ...
  async function kr(e, t) {
    try {
      ...
      throw (
        (wr.hit("Failed to load stylesheet", {id: e, base: t, error: r.message ?? r}),
        r)
      )
    }
  }
...
//# sourceMappingURL=/sm/9c145d7e749b2e511c6391d6e25ebf7e7310e690b2ac66928f74b80d2f306a17.map
